                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo mt-4">
                            <h1 style="color : black;font-family: 'Dancing Script', cursive;">
                                <img src="{{ asset('logo.png') }}" align="klassy cafe html template" width="60">
                                PPDB Wikrama Bogor
                            </h1>
                        </a>
                        <!-- ***** Logo End ***** -->
                ...
                <div class="col-lg-4">
                    <div class="left-content">
                        <div class="inner-content">
                            ...
                            <h4><img src="{{ asset('logo.png') }}" align="klassy cafe html template" width="80"> PPDB</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-content">
                        <div class="thumb">
                            <!-- <a rel="nofollow" href="https://www.youtube.com/channel/UCyhEUzlXbXet57qFnDfdWuw"><i class="fa fa-play"></i></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 offset-lg-4 text-center">
                    <div class="section-heading">
                        <h6>Our Teacher</h6>
                        <h2>Pengajar Terbaik Di Smk Wikrama Bogor</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    ...
                                    <h4>Phone Numbers</h4>
                                    <span><a href="#">0251-8242411 / 082221718035</a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="#">ichsanarrizqi@smkwikrama.sch.id</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <form id="contact" action="{{ route('store') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                        <input name="nisn" type="text" id="name" placeholder="NISN" required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <fieldset>
                                        <select value="number-guests" name="jenis_kelamin" id="number-guests">
                                            <option value="number-guests">Jenis Kelamin</option>
                                            <option name="Laki-Laki" id="Laki-Laki">Laki-Laki</option>
                                            <option name="Prempuan" id="Prempuan">Prempuan</option>
                                        </select>
                                    </fieldset>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                        <input name="tempat_lahir" type="text" id="tempat_lahir" placeholder="Tempat Lahir" required="">
                                    </fieldset>
                                </div>
                                <div class="col-lg-6">
                                    <div id="filterDate2">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                        <select value="" name="kelas" class="form-control" id="Kelas">
                                            <option value="">Kelas</option>
                                            <option name="X" id="X">X</option>
                                            <option name="XI" id="XI">XI</option>
                                            <option name="XII" id="XII">XII</option>
                                        </select>
                                    </fieldset>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                        <select value="" name="jurusan" class="form-control" id="jurusan">
                                            <option value="">Jurusan</option>
                                            <option name="RPL" id="RPL">RPL</option>
                                            <option name="MMD" id="MMD">MMD</option>
                                            <option name="TKJ" id="TKJ">TKJ</option>
                                            <option name="OTKP" id="OTKP">OTKP</option>
                                            <option name="BDP" id="BDP">BDP</option>
                                            <option name="TBG" id="TBG">TBG</option>
                                            <option name="HTL" id="HTL">HTL</option>
                                        </select>
                                    </fieldset>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <fieldset>
                                        <input name="asal_sekolah" type="text" id="asal_sekolah" placeholder="Asal Sekolah">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
